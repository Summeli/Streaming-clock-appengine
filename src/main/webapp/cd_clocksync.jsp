...
<%@ page import="com.finice.SendServlet" %>
  ...
  <body>
    ...
    <br>
    <label for="start">Clock staring time in seconds</label>
    <input type="number" id="start" name="start"
           min="0" max="600" value="600">
    <br>
    ...
    $(function() {
      ...
      document.getElementById('start').onclick = function() {
        websocket.send('s'+start);
        console.log("start");
        running = 1;
      };
      document.getElementById('stop').onclick = function() {
        websocket.send('p'+ sec);
        console.log("pause");
        running = 0;
      };
      document.getElementById('reset').onclick = function() {
         console.log("reset");
         websocket.send('r'+start);
         sec = start;
      ...
      window.onload = function init() {
         ...
         input.addEventListener("change", startUpdated, false);
        }

        function startUpdated(event)
        {
